...
public final class SqlQueries {
        ...
        public static final String SELECT_ALL_RESPONSABLES = "SELECT id, nom, prenom, username, email, role, solde_conges "
                        +
                        "FROM utilisateur WHERE role = 'RESPONSABLE' ORDER BY nom";
